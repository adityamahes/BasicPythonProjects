...
def start_timer():
    ...
    #playsound.playsound(r'C:\Users\mahes\Documents\Sound recordings\Recording.m4a')
    if reps % 8 == 0:
...
# Canvas Widget (to layer stuff)
canvas = Canvas(width=200, height=224, bg=YELLOW, highlightthickness=0)
tomato_img = PhotoImage(file="tomato.png")
canvas.create_image(100, 112, image=tomato_img)  # The image attribute will only take PhotoImage objects
